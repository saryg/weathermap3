...
# Paths
font_path = "/home/sara/Weathermap3/fonts/WalterTurncoat-Regular.ttf"
icon_path = "/home/sara/Weathermap3/icons-transparent/"
base_map_path = "/home/sara/Weathermap3/images/{country}_base_map.png"
weathermap_bmp_path = "/home/sara/Weathermap3/images/weathermap.bmp"

map_unit_shapefile_path = "/home/sara/Weathermap3/ne_10m_map_units/ne_10m_admin_0_map_units.shp"

radar_map_path = "/home/sara/Weathermap3/images/radar_map.png"
pickle_path = "/home/sara/Weathermap3/plots/{country}.axes.pickle"
...
rainviewer_radar_tile_url = (
    "https://tilecache.rainviewer.com/v2/radar/{timestamp}/256/{z}/{x}/{y}/1/0_1.png"
)
...
map_settings = {
    "Ireland": {
        ...
        "non_focus_country_codes": ["WLS", "ENG", "SCT"],
        "points_of_interest": {
    ...
    "Germany": {
        "centre_lon": 10,
        "zoom": 6,  # only 6
        "extent": [3.2, 19.4, 43.75, 58.45],  # [3, 17.5, 44, 58],
        ...
        "tiles": {6: {"xrange": range(33, 35), "yrange": range(20, 23)}},
    },
}
